...
public class GreetResource {
    ...
    @Counted(name="Card-Count-Metrics")
    @Metered(name="Card-metrics-time", unit=MetricUnits.MILLISECONDS,absolute=true)
    @Timed(name="card-count-timer",unit=MetricUnits.MILLISECONDS,absolute=true)
    ...
    //Added implementation of restClient
    @Inject
    @RestClient
